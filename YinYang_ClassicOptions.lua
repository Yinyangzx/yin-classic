--[[
    ...
    3. Subir a GitHub y copiar la URL raw.
    4. Dentro de Window:CreateClassicTab() en la librería, agregar:

           TabClassic:CreateScriptToggle(
               "Texto en español",   -- label bilingüe ES
               "Text in English",    -- label bilingüe EN
               "https://raw.githubusercontent.com/.../NombreScript.lua",
               "NombreScript"        -- scriptKey: debe coincidir con _YY_STOP_<este>
           )
...
if _G["_YY_STOP_HideGuis"] then
    _G["_YY_STOP_HideGuis"]()
end
...
-- ════════════════════════════════════════════════════════════════════════
_G["_YY_STOP_HideGuis"] = function()
    if hidden then showAll() end
    pcall(function() gui:Destroy() end)
    _G["_YY_STOP_HideGuis"] = nil
end
